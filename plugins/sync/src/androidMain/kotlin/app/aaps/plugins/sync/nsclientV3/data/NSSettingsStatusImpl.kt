 ...
 */
@ContributesBinding(AppScope::class, binding = binding<NSSettingsStatus>())
@SingleIn(AppScope::class)
@Inject
class NSSettingsStatusImpl(
    ...
    override fun handleNewData(status: JSONObject) {
        ...
        if (getVersionNum() < config.SUPPORTED_NS_VERSION) {
            notificationManager.post(NotificationId.OLD_NS, SyncStrings.unsupported_ns_version, level = NotificationLevel.NORMAL)
        } else {
