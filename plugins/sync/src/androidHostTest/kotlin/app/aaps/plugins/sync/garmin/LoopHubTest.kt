...
class LoopHubTest : TestBase() {
    ...
    fun setup() {
        ...
        // getGlucoseValues overlays the 5 minute buckets on the stored readings. This store holds
        // none of them (a bare mock answers null for bucketedData, and the code turns that into an
        // empty list), so the stored readings come back as they are.
        ...
        loopHub = LoopHubImpl(
            ...
            dateUtil, wizardBolusExecutor, activePlugin, testScope
        )
        loopHub.clock = clock
    }
