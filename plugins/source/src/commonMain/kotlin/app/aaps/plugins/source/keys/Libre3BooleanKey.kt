...
enum class Libre3BooleanKey(
    ...
    UseRealSkeleton(
        ...
        defaultValue = false,
        title = SourceStrings.libre3_use_real_skeleton,
        summary = SourceStrings.libre3_use_real_skeleton_summary,
    ...
    PresoakEnabled(
        ...
        defaultValue = false,
        title = SourceStrings.libre3_presoak_enabled,
        summary = SourceStrings.libre3_presoak_enabled_summary,
        engineeringModeOnly = true,
        exportable = false,
    ),
    ...
    KeepSessionAlive(
        ...
        defaultValue = false,
        title = SourceStrings.libre3_keep_session_alive,
        summary = SourceStrings.libre3_keep_session_alive_summary,
        engineeringModeOnly = true,
        exportable = false,
    ),
}
