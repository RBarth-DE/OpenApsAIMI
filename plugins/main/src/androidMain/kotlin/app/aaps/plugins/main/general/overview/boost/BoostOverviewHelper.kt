...
class BoostOverviewHelper @Inject constructor(
    ...
    enum class BoostV5State(val label: String, val verb: String, val short: String, val colorHex: Long) {
        ...
        companion object {
            suspend fun fromName(text: String?): BoostV5State =
    ...
    enum class BoostTier(val label: String, val colorHex: Long) {
        ...
        companion object {
            suspend fun fromLabel(text: String): BoostTier {
     ...
     */
    suspend fun getBoostStatus(): BoostStatus {
    ...
    private suspend fun computeBoostStatus(): BoostStatus {
        ...
        val deltaAccl = json?.optDoubleCompat("delta_accl", 0.0) ?: rt?.deltaAcceleration ?: 0.0
        ...
        val profilePct = json?.optIntCompat("current_profile_percentage", 0) ?: rt?.boostProfileSwitch ?: 0
    ...
    private suspend fun parseTierFromText(text: String): Pair<BoostTier, String>? {
    ...
    private suspend fun parseActivityFromText(text: String): Pair<ActivityMode, String> {
    ...
    private suspend fun parseTddFromText(text: String): Double {
    ...
    private suspend fun getAgeDays(type: TE.Type): Double {
    ...
    companion object {
         ...
         */
        suspend fun parseGateReductions(raw: String?): List<BoostV5Brake> {
