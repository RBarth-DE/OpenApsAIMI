...
fun AimiLearnerOverviewScreen(
    ...
    Scaffold(
        topBar = {
            AapsTopAppBar(
                title = { Text(stringResource(ApsStrings.aimi_learner_overview_title)) },
                navigationIcon = {
        ...
        Column(
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_governance_name),
                description = stringResource(ApsStrings.aimi_learner_governance_desc),
                warmupHours = 3.0,
                fullHours = 24.0,
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_reactivity_name),
                description = stringResource(ApsStrings.aimi_learner_reactivity_desc),
                warmupHours = 2.0,
                fullHours = 24.0,
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_basal3scale_name),
                description = stringResource(ApsStrings.aimi_learner_basal3scale_desc),
                warmupHours = 2.0,
                fullHours = 72.0,
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_pkpd_name),
                description = stringResource(ApsStrings.aimi_learner_pkpd_desc),
                warmupHours = 0.3,
                fullHours = 72.0,
                enabled = preferences?.get(BooleanKey.OApsAIMIPkpdEnabled) == true,
                elapsedHours = pkpdElapsedHours,
                liveStatus = stringResource(ApsStrings.aimi_learner_pkpd_status),
            )
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_online_name),
                description = stringResource(ApsStrings.aimi_learner_online_desc),
                warmupHours = 0.5,
                fullHours = 48.0,
                enabled = preferences?.get(BooleanKey.OApsAIMIautoDriveActive) == true,
                elapsedHours = onlineLearner?.elapsedLearningHours,
                liveStatus = stringResource(ApsStrings.aimi_learner_online_status),
            )
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_ngr_name),
                description = stringResource(ApsStrings.aimi_learner_ngr_desc),
                warmupHours = 0.0,
                fullHours = 12.0,
                enabled = preferences?.get(BooleanKey.OApsAIMINightGrowthEnabled) == true,
                liveStatus = stringResource(ApsStrings.aimi_learner_ngr_status),
            )
            ...
            // ── 7. WCycleLearner ──
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_wcycle_name),
                description = stringResource(ApsStrings.aimi_learner_wcycle_desc),
                warmupHours = 720.0,
                fullHours = 2160.0,
                enabled = preferences?.get(BooleanKey.OApsAIMIwcycle) == true,
                liveStatus = stringResource(ApsStrings.aimi_learner_wcycle_status),
            )
            ...
            LearnerCard(
                title = stringResource(ApsStrings.aimi_learner_governors_name),
                description = stringResource(ApsStrings.aimi_learner_governors_desc),
                warmupHours = 6.0,
                fullHours = 72.0,
                ...
                elapsedHours = pkpdElapsedHours,
                liveStatus = stringResource(ApsStrings.aimi_learner_governors_status),
            )
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (!enabled) {
                    ...
                    Text(
                        text = stringResource(ApsStrings.aimi_learner_disabled_badge),
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(
                    text = stringResource(ApsStrings.aimi_learner_time_to_full_label),
                    style = MaterialTheme.typography.labelSmall,
