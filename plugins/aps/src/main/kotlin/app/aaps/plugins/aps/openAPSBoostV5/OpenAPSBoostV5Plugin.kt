...
open class OpenAPSBoostV5Plugin @Inject constructor(
    ...
    PluginDescription()
        ...
        .pluginName(R.string.openaps_boost_v6)
    ...
    override suspend fun isSMBModeEnabled(value: Constraint<Boolean>): Constraint<Boolean> = openAPSBoostEngine.get().isSMBModeEnabled(value)
    ...
    override suspend fun applyMaxIOBConstraints(maxIob: Constraint<Double>): Constraint<Double> = openAPSBoostEngine.get().applyMaxIOBConstraints(maxIob)
    ...
    override suspend fun onStart() { super.onStart(); openAPSBoostEngine.get().onStart() }
    override suspend fun onStop() { openAPSBoostEngine.get().onStop(); super.onStop() }
