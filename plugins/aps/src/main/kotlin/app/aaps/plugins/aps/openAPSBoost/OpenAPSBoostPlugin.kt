...
open class OpenAPSBoostPlugin @Inject constructor(
    ...
    private val loopProvider: Provider<app.aaps.core.interfaces.aps.Loop>
) : PluginBase(
    PluginDescription()
    ...
    suspend fun runEngine(initiator: String, tempBasalFallback: Boolean, v5Active: Boolean) {
        ...
        if (recentLowBG < 100.0 && glucoseStatus.glucose > recentLowBG + 20) {
            ...
            if (activeTt != null && activeTt.reason == TT.Reason.ACTIVITY) {
                ...
                isTempTarget = false
                minBg = hardLimits.verifyHardLimits(Round.roundTo(profile.getTargetLowMgdl(), 0.1), app.aaps.core.ui.R.string.profile_low_target, HardLimits.LIMIT_MIN_BG)
                maxBg = hardLimits.verifyHardLimits(Round.roundTo(profile.getTargetHighMgdl(), 0.1), app.aaps.core.ui.R.string.profile_high_target, HardLimits.LIMIT_MAX_BG)
