...
/*
 * AIMI Settings Restructuring ‚Äî 2026-06-10
 *
 * Changes:
 * - Restored aimiComposeAdaptiveBasalSubScreen() as separate screen (Universal Adaptive Basal + Governance)
 *   ‚Äî independent from T3c Brittle Mode; both systems feed into adaptiveMult via different paths
...
// Construit lùobjet attendu par determine_basal
     ...
     */
    private fun buildAimiComposePreferenceItems(): List<PreferenceItem> = buildList {
        // Questo creer√† la sezione che l'utente pu√≤ espandere o comprimere a piacimento in loco
        add(
            PreferenceSubScreenDef(
    ...
    private fun aimiComposeUserPreferenceItems(): List<PreferenceItem> = buildList {
        ...
        // ‚îÄ‚îÄ 1b. Manual modes & Advisor ‚îÄ‚îÄ
        ...
        // ‚îÄ‚îÄ 5. Biorhythm & Safety ‚îÄ‚îÄ
        add(aimiComposeKetoProtectionSubScreen())

        // ‚îÄ‚îÄ 6. Patient & Body ‚îÄ‚îÄ
    ...
    private fun aimiComposeAdaptiveBasalSubScreen(): PreferenceSubScreenDef =
        PreferenceSubScreenDef(
            ...
            items = listOf(
                ...
                DoubleKey.OApsAIMIMaxMultiplier,  // multiplicative ceiling for basal (√ó profile), clamped 1.0‚Äì2.5
    ...
    private fun aimiComposeCoreSmbSubScreen(): PreferenceSubScreenDef =
        PreferenceSubScreenDef(
            ...
            items = listOf(
                ...
                DoubleKey.OApsAIMIHighBg,              // General high-BG threshold ‚Äî used across HTR, phase classifier, scenario projection, exercise overrides
                BooleanKey.OApsAIMIUnifiedReactivityEnabled,
                // BooleanKey.OApsAIMIEnableBasal, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                // OApsAIMIIobSurveillanceGuard ‚Üí in PKPD screen (Red Carpet / IOB Surveillance)
            ),
        )
    ...
    private fun aimiComposeNightGrowthSubScreen(): PreferenceSubScreenDef =
        PreferenceSubScreenDef(
            ...
            items = listOf(
                ...
                DoubleKey.OApsAIMINightGrowthSmbMultiplier,      // active ‚Äî read by DetermineBasalAIMI2.kt
                DoubleKey.OApsAIMINightGrowthBasalMultiplier,    // active ‚Äî read by DetermineBasalAIMI2.kt
                // DoubleKey.OApsAIMINightGrowthMinRiseSlope,    // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                // DoubleKey.OApsAIMINightGrowthMaxSmbClamp,     // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                // DoubleKey.OApsAIMINightGrowthDecayMinutes,    // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                // IntKey.OApsAIMINightGrowthMinDurationMin,     // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                // IntKey.OApsAIMINightGrowthMinEventualOverTarget, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
            ),
        )
            ...
            items = buildList {
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMIBFFactor,    // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMILunchFactor, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMIDinnerFactor, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMIHCFactor,    // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMISnackFactor, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            ...
                            // DoubleKey.OApsAIMIMealFactor,  // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
                ...
                add(
                    PreferenceSubScreenDef(
                        ...
                        items = listOf(
                            // DoubleKey.OApsAIMIsleepFactor, // ORPHANED ‚Äî not read by DetermineBasalAIMI2.kt
