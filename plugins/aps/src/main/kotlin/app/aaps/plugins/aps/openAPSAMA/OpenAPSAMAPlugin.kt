...
class OpenAPSAMAPlugin @Inject constructor(
    ...
    override suspend fun invoke(initiator: String, tempBasalFallback: Boolean) = withContext(Dispatchers.Default) {
        ...
        if (!hardLimits.checkHardLimits(profile.getIsfMgdl("OpenAPSAMAPlugin"), app.aaps.core.ui.R.string.profile_sensitivity_value, HardLimits.LIMIT_ISF.start, HardLimits.LIMIT_ISF.endInclusive)) return@withContext
