...
class OpenAPSFragment : DaggerFragment(), MenuProvider {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = OpenapsFragmentBinding.inflate(inflater, container, false)
    ...
    override fun onCreateMenu(menu: Menu, inflater: MenuInflater) {
        menu.add(Menu.FIRST, ID_MENU_RUN, 0, "Run").setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER)
    ...
    private fun updateGUI() {
        ...
        openAPSPlugin?.lastAPSResult?.let { lastAPSResult ->
            ...
            binding.profile.text = lastAPSResult.oapsProfile?.dataClassToHtml() ?: lastAPSResult.oapsProfileAutoIsf?.dataClassToHtml() ?: lastAPSResult.oapsProfileAimi?.dataClassToHtml()
