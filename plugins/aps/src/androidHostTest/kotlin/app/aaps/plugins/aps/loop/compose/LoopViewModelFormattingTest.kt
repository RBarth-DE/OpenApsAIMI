...
internal class LoopViewModelFormattingTest {
    ...
    private class FakeTextResources : ResourceHelper {
        ...
        // The merged ResourceHelper also carries the Android resource lookups the fork's classic
        // views use. The loop view model formats text only, so none of them is called here: they
        // fail loudly rather than answering a value that would be wrong.
        override fun gc(id: Int): Int = notAnswered
        override fun gac(attributeId: Int): Int = notAnswered
        override fun gac(context: Context?, attributeId: Int): Int = notAnswered
        override fun gd(id: Int): Drawable? = notAnswered
        override fun gb(id: Int): Boolean = notAnswered
        override fun gcs(id: Int): String = notAnswered
        override fun gsa(id: Int): Array<String> = notAnswered
        override fun openRawResourceFd(id: Int): AssetFileDescriptor? = notAnswered
        override fun decodeResource(id: Int): Bitmap = notAnswered
        override fun getDisplayMetrics(): DisplayMetrics = notAnswered
        override fun dpToPx(dp: Int): Int = notAnswered
        override fun dpToPx(dp: Float): Int = notAnswered

        private val notAnswered: Nothing
            get() = error("FakeTextResources only answers strings")
    }
