...
class AimiAdaptationStatusBuilderTest {
    ...
    fun `RT status remains outside serialized wire format`() {
        ...
        // aimiAdaptationStatus is a class-body property of RT, not a constructor parameter, so it is
        // set after construction - the same way production does it.
        rt.aimiAdaptationStatus = AimiAdaptationStatusBuilder.build(emptyInput())
