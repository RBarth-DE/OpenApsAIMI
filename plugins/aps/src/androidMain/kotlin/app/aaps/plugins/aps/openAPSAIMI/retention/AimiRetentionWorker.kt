 ...
 */
@AssistedInject
class AimiRetentionWorker(
    // These names must match Factory.create() exactly: Metro's assisted-injection check compares
    // name and type, and fails the build with ASSISTED_INJECTION_ERROR when they differ.
    ...
    fun interface Factory : MetroWorkerCreator {
        ...
        override fun create(context: Context, params: WorkerParameters): AimiRetentionWorker
    }
}
