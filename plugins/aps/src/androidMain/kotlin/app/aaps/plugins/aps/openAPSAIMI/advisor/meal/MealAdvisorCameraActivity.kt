...
import app.aaps.core.ui.extensions.onSystemBarInsets
...
class MealAdvisorCameraActivity : AppCompatActivity() {
    ...
    /** Distance of the capture button from the bottom of the screen, before the system bars. */
    private val captureButtonMargin = 64
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        captureButton = Button(this).apply {
            ...
            layoutParams = FrameLayout.LayoutParams(
                ...
                bottomMargin = captureButtonMargin
            }
        ...
        // The preview fills the whole screen on purpose, so the root is not padded. Only the capture
        // button is lifted above the navigation bar, which the system draws on top of this window.
        root.onSystemBarInsets { bars ->
            val params = captureButton.layoutParams as FrameLayout.LayoutParams
            params.bottomMargin = captureButtonMargin + bars.bottom
            captureButton.layoutParams = params
        }
    }
