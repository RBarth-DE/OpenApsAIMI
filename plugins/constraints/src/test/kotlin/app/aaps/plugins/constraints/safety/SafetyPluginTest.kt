...
class SafetyPluginTest : TestBaseWithProfile() {
    ...
    private lateinit var loopProvider: Provider<Loop>
    ...
    fun prepare() {
        ...
        openAPSAMAPlugin =
            OpenAPSAMAPlugin(
                ...
                GlucoseStatusCalculatorSMB(aapsLogger, iobCobCalculator, dateUtil, decimalFormatter, deltaCalculator), apsResultProvider, ch, fabricPrivacy, loopProvider
            )
    }
