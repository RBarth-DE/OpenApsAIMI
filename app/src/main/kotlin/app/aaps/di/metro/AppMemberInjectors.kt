...
object AppMemberInjectors {
    ...
    @FeatureMemberInjectors
    @IntoMap
    @ClassKey(ComparatorActivity::class)
    fun bindComparatorActivity(injector: MembersInjector<ComparatorActivity>): MembersInjector<*> = injector

    @Provides
    @FeatureMemberInjectors
    @IntoMap
    @ClassKey(DashboardPreviewActivity::class)
    fun bindDashboardPreviewActivity(injector: MembersInjector<DashboardPreviewActivity>): MembersInjector<*> = injector
}
