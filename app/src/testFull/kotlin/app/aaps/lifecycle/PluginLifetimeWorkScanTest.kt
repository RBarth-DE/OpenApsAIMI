...
class PluginLifetimeWorkScanTest {
     ...
     *
     * Four fork-only entries were recorded on 2026-09-21 (one in `LoopPlugin` and three in
     * `EversensePlugin`) when the merge from upstream `dev` brought this scan. The decision to
     * record them rather than change the plugins in a merge is in `docs/MERGE_DEV_2026-09-21.md`.
     * A fifth, `LoopPlugin#executeInvokeInternal`, was fixed by upstream's `scheduleSmbFallback`
     * in the 2026-09-24 merge and dropped here.
     */
