...
class ContributedPluginsTest {
    ...
    fun `every contributed plugin appears under its order key`() {
        assertThat(plugins.keys).containsExactly(
            ...
            10,
            // FORK: overview / dashboard skin switch
            20,
            // sensitivity
            100, 110, 120,
            // FORK: 225 AIMI, 231 Boost, 239 BoostV5
            200, 210, 220, 225, 230, 231, 239, 240,
            // FORK: 445 Eversense, 446 Dexcom ONE+, 447 Libre 3, 475 Ottai
            400, 410, 420, 430, 440, 445, 446, 447, 450, 460, 470, 475, 480, 490, 500, 510, 520, 530, 540, 550,
            ...
            // FORK: 315 RemoteControl
            310, 315, 330, 350, 360, 370,
            // smoothing - FORK: 615 adaptive smoothing
            600, 610, 615, 620, 630,
            // calibration
            700, 710,
