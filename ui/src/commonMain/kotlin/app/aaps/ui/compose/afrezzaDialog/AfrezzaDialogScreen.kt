...
fun AfrezzaDialogScreen(
    viewModel: AfrezzaDialogViewModel = metroViewModel(),
    onNavigateBack: () -> Unit,
    onOpenWizard: () -> Unit = {},
    ...
    if (uiState.showConfirmation && uiState.selectedCartridge != null) {
        OkCancelDialog(
            title = stringResource(UiStrings.afrezza_confirm_title),
            message = stringResource(UiStrings.afrezza_confirm_log, uiState.selectedCartridge!!),
    ...
    if (uiState.showCarbPrompt) {
        OkCancelDialog(
            title = stringResource(UiStrings.afrezza_carb_prompt_title),
            message = stringResource(UiStrings.afrezza_carb_prompt_message),
...
private fun AfrezzaCartridgeSelector(
    ...
    Column(
        ...
        Text(
            text = stringResource(UiStrings.afrezza_select_dose),
...
private fun CartridgeButton(
    ...
    Button(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = stringResource(CoreUiStrings.insulin_unit_shortname),
                fontSize = 12.sp
            )
        }
    }
...
private fun AfrezzaNotConfiguredContent() {
    Card(
        ...
        Text(
            text = stringResource(UiStrings.afrezza_not_configured),
