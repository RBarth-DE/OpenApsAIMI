...
internal fun DurationStep(
    ...
    WizardStepLayout(
        ...
        NumberInputRow(
            ...
            step = 5.0,
            // "%1$d min" takes a whole number, so the rounding travels with the template here
            // instead of as a separate flag.
            unitFormat = UnitFormat(InterfacesStrings.mins, asWholeNumber = true),
            displayValue = when {
