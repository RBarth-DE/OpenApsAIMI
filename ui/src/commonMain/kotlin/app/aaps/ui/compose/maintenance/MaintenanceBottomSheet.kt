...
internal fun MaintenanceBottomSheetContent(
    ...
    Column(
        ...
        MaintenanceItem(
            text = stringResource(CoreUiStrings.maintenance_export_aimi_cloud_title),
            description = stringResource(CoreUiStrings.maintenance_export_aimi_cloud_desc),
            icon = Icons.Default.Cloud,
            color = primaryColor,
            onDismiss = onDismiss,
            onClick = {
            ...
            trailingContent = exportConfig?.let {
                {
                    FilterChip(
                        ...
                        label = {
                            Text(
                                text = stringResource(CoreUiStrings.maintenance_export_aimi_cloud_chip),
