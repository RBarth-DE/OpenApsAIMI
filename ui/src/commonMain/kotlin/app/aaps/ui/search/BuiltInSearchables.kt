    ...
    val appearance = PreferenceSubScreenDef(
        ...
        items = listOf(
            StringKey.GeneralSkin.withEntries(
                // Skin descriptions still come as Android resource ids, so they are wrapped in
                // TextRef.AndroidRes - the form meant for a module that still owns AAPT resources.
            ...
            PreferenceSubScreenDef(
                ...
                title = KeysStrings.prefs_vico_chart_appearance_title,
                items = listOf(
