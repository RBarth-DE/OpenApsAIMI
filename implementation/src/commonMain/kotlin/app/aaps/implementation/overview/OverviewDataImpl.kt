...
class OverviewDataImpl() : OverviewData {
    /** Marker for "no graph data". The real series are built by the plugins/main implementation. */
    ...
    // Hours of graph window. Same default the fromTime initializer above already uses.
