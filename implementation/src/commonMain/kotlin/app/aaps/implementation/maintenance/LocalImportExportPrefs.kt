...
class LocalImportExportPrefs(
    ...
    override fun getExportConfig(): ExportConfig {
        ...
        return ExportConfig(
            ...
            // This platform has no AIMI cloud backup at all, so the toggle is always off.
            aimiCloud = false,
    ...
    override fun setAimiCloudEnabled(enabled: Boolean) = notHere("setAimiCloudEnabled")
    ...
    override suspend fun uploadFileToCloud(
        ...
        notHere("uploadFileToCloud")
        // Honest failure: the file really was not uploaded, so no caller can mistake this for success.
        return false
    }
