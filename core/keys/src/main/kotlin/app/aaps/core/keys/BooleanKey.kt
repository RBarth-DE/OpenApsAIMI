...
enum class BooleanKey(
    ...
    ApsUseAutoIsfWeights("openapsama_enable_autoISF", true, R.string.pref_title_aps_use_autoisf_weights, R.string.pref_summary_aps_use_autoisf_weights, defaultedBySM = true),
