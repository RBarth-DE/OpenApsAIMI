...
enum class BooleanKey(
    ...
    // AIMI entries
    OApsAIMIMLtraining("key_enable_ML_training", defaultValue = false),
    OApsAIMIEnableBasal("key_enable_basal", defaultValue = false),
    OApsAIMIEnableStepsFromWatch("count_steps_watch", defaultValue = false),
    OApsAIMIpregnancy("key_use_AimiPregnancy", defaultValue = false),
    OApsAIMIforcelimits("key_use_AimiForceLimits", defaultValue = false),
    OApsAIMInight("OApsAIMI_Enable_night", defaultValue = false),
    OApsAIMIhoneymoon("key_use_Aimi_honeymoon", defaultValue = false),
    ...
    OApsAIMIT3cAdaptiveBasalEnabled("key_use_aimi_t3c_adaptive_basal", defaultValue = false),
    OApsAIMIAutodriveV3EnhancedGater("key_use_aimi_autodrive_v3_enhanced_gater", defaultValue = false),
    ...
    OApsAIMIWCycleShadow("key_use_Aimi_wcycle_shadow", defaultValue = false),
    OApsAIMIWCycleRequireConfirm("key_use_Aimi_wcycle_require_confirm", defaultValue = false),
    OApsAIMINightGrowthEnabled("key_oaps_aimi_ngr_enabled", defaultValue = true),
    OApsAIMIPkpdEnabled("key_aimi_pkpd_enabled", defaultValue = false),
    OApsAIMIPkpdPragmaticReliefEnabled("key_aimi_pkpd_pragmatic_relief_enabled", defaultValue = true),
    OApsAIMIT3cBrittleMode("key_aimi_t3c_brittle_mode", defaultValue = false),
    OApsAIMIThyroidEnabled("key_aimi_thyroid_enabled", defaultValue = false),
    OApsAIMIThyroidLogVerbosity("key_aimi_thyroid_debug", defaultValue = false),
    AimiPhysioAssistantEnable("aimi_physio_assistant_enable", defaultValue = false),
    AimiPhysioSleepDataEnable("aimi_physio_sleep_enable", defaultValue = true),
    AimiPhysioHRVDataEnable("aimi_physio_hrv_enable", defaultValue = true),
    AimiPhysioLLMAnalysisEnable("aimi_physio_llm_enable", defaultValue = false),
    AimiPhysioDebugLogs("aimi_physio_debug_logs", defaultValue = false),
    AimiEndometriosisEnable("aimi_endo_enable", defaultValue = false),
    AimiEndometriosisHormonalSuppression("aimi_endo_suppression", defaultValue = false),
    AimiEndometriosisPainFlare("aimi_endo_flare", defaultValue = false),
    AimiCosineGateEnabled("aimi_cosine_gate_enabled", defaultValue = true),
    AimiEmergencySosEnable("aimi_emergency_sos_enable", defaultValue = false),
}
