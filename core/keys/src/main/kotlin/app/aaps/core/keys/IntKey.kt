...
enum class IntKey(
    ...
    // AIMI entries
    OApsAIMIHighBGinterval("key_oaps_aimi_highBG_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMImealinterval("key_oaps_aimi_meal_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMILunchinterval("key_oaps_aimi_lunch_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMIDinnerinterval("key_oaps_aimi_dinner_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMIHCinterval("key_oaps_aimi_HC_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMISnackinterval("key_oaps_aimi_snack_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMIBFinterval("key_oaps_aimi_BF_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMISleepinterval("key_oaps_aimi_sleep_interval", defaultValue = 3, min = 1, max = 20),
    OApsAIMIAutodriveTarget("key_oaps_aimi_autodriveTarget", defaultValue = 70, min = 1, max = 160),
    OApsAIMIAutodriveBG("key_oaps_aimi_autodriveBG", defaultValue = 90, min = 1, max = 160),
    OApsAIMIWCycleAvgLength("key_wcycle_avg_length", defaultValue = 28, min = 20, max = 90),
    OApsAIMINightGrowthAgeYears("key_oaps_aimi_ngr_age_years", defaultValue = 14, min = 1, max = 25),
    OApsAIMINightGrowthMinDurationMin("key_oaps_aimi_ngr_min_duration", defaultValue = 30, min = 5, max = 240),
    OApsAIMINightGrowthMinEventualOverTarget("key_oaps_aimi_ngr_min_eventual_over_target", defaultValue = 15, min = 0, max = 120),
    OApsAIMINightGrowthDecayMinutes("key_oaps_aimi_ngr_decay_minutes", defaultValue = 20, min = 0, max = 120),
    OApsAIMIlogsize("key_oaps_aimi_logsize", defaultValue = 25, min = 1, max = 50),
    AimiEndometriosisFlareDuration("aimi_endo_flare_duration", defaultValue = 4, min = 1, max = 24),
    AimiCosineGateMaxPeakShift("aimi_cosine_gate_max_shift", defaultValue = 15, min = 0, max = 60),
    AimiEmergencySosThreshold("aimi_emergency_sos_threshold", defaultValue = 75, min = 70, max = 200),
    AimiEmergencySosImmediateThreshold("aimi_emergency_sos_immediate_threshold", defaultValue = 60, min = 55, max = 200),
    AimiEmergencySosStaleThreshold("aimi_emergency_sos_stale_threshold", defaultValue = 30, min = 15, max = 200),
}
