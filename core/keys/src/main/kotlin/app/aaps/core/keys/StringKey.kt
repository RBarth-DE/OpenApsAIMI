...
enum class StringKey(
    ...
    // AIMI entries
    OApsAIMIWCycleTrackingMode("key_oaps_aimi_wcycle_tracking_mode", defaultValue = "FIXED_28"),
    OApsAIMIWCycleContraceptive("key_oaps_aimi_wcycle_contraceptive", defaultValue = "NONE"),
    OApsAIMIWCycleThyroid("key_oaps_aimi_wcycle_thyroid", defaultValue = "EUTHYROID"),
    OApsAIMIWCycleVerneuil("key_oaps_aimi_wcycle_verneuil", defaultValue = "NONE"),
    OApsAIMINightGrowthStart("key_oaps_aimi_ngr_night_start", defaultValue = "22:00"),
    OApsAIMINightGrowthEnd("key_oaps_aimi_ngr_night_end", defaultValue = "06:00"),
    AimiAdvisorOpenAIKey("aimi_advisor_openai_key", defaultValue = "", isPassword = true),
    AimiAdvisorGeminiKey("aimi_advisor_gemini_key", defaultValue = "", isPassword = true),
    AimiAdvisorDeepSeekKey("aimi_advisor_deepseek_key", defaultValue = "", isPassword = true),
    AimiAdvisorClaudeKey("aimi_advisor_claude_key", defaultValue = "", isPassword = true),
    AimiAdvisorProvider("aimi_advisor_provider", defaultValue = "OPENAI"),
    ContextLLMProvider("aimi_context_llm_provider", defaultValue = "OPENAI"),
    ContextLLMOpenAIKey("aimi_context_llm_openai_key", defaultValue = "", isPassword = true),
    ContextLLMGeminiKey("aimi_context_llm_gemini_key", defaultValue = "", isPassword = true),
    ContextLLMDeepSeekKey("aimi_context_llm_deepseek_key", defaultValue = "", isPassword = true),
    ContextLLMClaudeKey("aimi_context_llm_claude_key", defaultValue = "", isPassword = true),
    OApsAIMIUnstableModeState("key_oaps_aimi_mode_state", defaultValue = ""),
    OApsAIMIContextStorage("aimi_context_storage", defaultValue = "", exportable = false),
    AimiPhysioLLMProvider("aimi_physio_llm_provider", defaultValue = "gpt4"),
    OApsAIMIThyroidMode("key_aimi_thyroid_mode", defaultValue = "MANUAL"),
    OApsAIMIThyroidManualStatus("key_aimi_thyroid_manual_status", defaultValue = "EUTHYROID"),
    OApsAIMIThyroidTreatmentPhase("key_aimi_thyroid_treatment_phase", defaultValue = "NONE"),
    OApsAIMIThyroidGuardLevel("key_aimi_thyroid_guard_level", defaultValue = "HIGH"),
    AimiEmergencySosPhone("aimi_emergency_sos_phone", defaultValue = ""),
    AimiEmergencySosPhone2("aimi_emergency_sos_phone2", defaultValue = ""),
}
