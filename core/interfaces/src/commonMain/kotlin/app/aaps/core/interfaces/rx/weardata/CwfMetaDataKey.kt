...
enum class CwfMetadataKey(val key: String, val label: TextRef, val isPref: Boolean) {
    ...
    CWF_PREF_WATCH_SHOW_COMPLICATION1("key_show_complication1", InterfacesStrings.pref_show_complication1, true),
    CWF_PREF_WATCH_SHOW_COMPLICATION2("key_show_complication2", InterfacesStrings.pref_show_complication2, true),
