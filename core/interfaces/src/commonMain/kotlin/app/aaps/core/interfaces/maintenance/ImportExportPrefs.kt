...
data class ExportConfig(
    ...
    /** AIMI backup: a successful settings export to cloud also triggers the AIMI cloud backup. */
...
interface ImportExportPrefs {
    ...
    /** Fork: upload one file to the configured cloud backend (used by AIMI workflows). */
