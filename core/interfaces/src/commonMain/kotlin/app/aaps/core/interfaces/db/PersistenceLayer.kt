...
interface PersistenceLayer {
     ...
     */
    fun databaseClearedFlow(): Flow<Unit>
    ...
    /**
     * Delete the newest therapy event whose note contains the given keyword.
     *
     * Used by the therapy helper to close the event that a stopped activity opened.
     *
     * @param noteKeyword text to look for in the note
     */
