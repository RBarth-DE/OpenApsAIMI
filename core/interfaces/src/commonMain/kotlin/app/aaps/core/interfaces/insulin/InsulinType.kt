...
enum class InsulinType(val value: Int, val insulinEndTime: Long, val insulinPeakTime: Long, val label: TextRef, val comment: TextRef, val isInhaled: Boolean = false) {
    ...
    OREF_INHALED_AFREZZA(6, (2.5 * 3600 * 1000).toLong(), 40 * 60000L, InterfacesStrings.inhaled_afrezza, InterfacesStrings.inhaled_afrezza_comment, isInhaled = true);
