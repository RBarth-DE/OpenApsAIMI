...
fun ElementType.label(): TextRef? = when (this) {
    ...
    ElementType.AFREZZA                 -> CoreUiStrings.overview_afrezza_label
    ...
    ElementType.BGSOURCE                -> CoreUiStrings.cgm
...
fun ElementType.description(): TextRef? = when (this) {
    ...
    ElementType.AFREZZA                 -> CoreUiStrings.treatment_afrezza_desc
