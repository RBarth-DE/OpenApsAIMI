...
import app.aaps.core.keys.AimiPreferenceSummaries
...
fun AdaptiveSwitchPreferenceItem(
    ...
    // Fork: AIMI keys carry their summary in a generated lookup, because the key itself has none.
    val effectiveSummary = summary
        ?: booleanKey.summary
        ?: AimiPreferenceSummaries.map[booleanKey.key]
