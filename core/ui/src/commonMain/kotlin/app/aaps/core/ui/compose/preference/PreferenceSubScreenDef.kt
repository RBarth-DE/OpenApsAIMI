...
data class PreferenceSubScreenDef(
     ...
     *
     * Entries with a blank title are still returned here, because a key with no label is a normal
     * thing in this code base. Drop them where the line is built, with `preferenceSummaryLine`, which
     * is the only place that should join these - joining a blank one leaves a leading comma.
     */
