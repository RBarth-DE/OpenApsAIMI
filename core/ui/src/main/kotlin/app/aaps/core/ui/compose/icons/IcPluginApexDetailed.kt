...
/**
 * Placeholder icon for Apex Pump Plugin.
 * Based on the generic Pump icon until the original ic_apex_detailed resource is recovered.
 */
val IcPluginApexDetailed: ImageVector by lazy {
    ImageVector.Builder(
        name = "IcPluginApexDetailed",
        defaultWidth = 48.dp,
        defaultHeight = 48.dp,
        viewportWidth = 48f,
        viewportHeight = 48f
...
@Composable
private fun IcPluginApexDetailedPreview() {
    Icon(
        imageVector = IcPluginApexDetailed,
        contentDescription = "Apex Plugin Icon",
        modifier = Modifier
            .padding(0.dp)
            .size(48.dp),
