...
class HardLimitsMock(
    ...
    // The ends of those ranges. HardLimitsImpl reads the same arrays, indexed by the age ordinal.
    override fun minDia(): Double = HardLimits.MIN_DIA[loadAge().ordinal]
    override fun maxDia(): Double = HardLimits.MAX_DIA[loadAge().ordinal]
    override fun minDiaInhaled(): Double = HardLimits.MIN_DIA_INHALED[loadAge().ordinal]
    override fun maxDiaInhaled(): Double = HardLimits.MAX_DIA_INHALED[loadAge().ordinal]
    ...
    override fun minIC(): Double = HardLimits.MIN_IC[loadAge().ordinal]
    override fun maxIC(): Double = HardLimits.MAX_IC[loadAge().ordinal]
