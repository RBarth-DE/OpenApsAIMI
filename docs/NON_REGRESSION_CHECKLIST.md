...
**Latest merge log:** [MERGE_DEV_2026-09-24.md](MERGE_DEV_2026-09-24.md) (`upstream/dev` @ `7e1d537d49` and `mtr/dev_OAPSAIMI` @ `166ddb6db0` → `dev_OAPSAIMI_RB`; plugin enforcements + auditor profile factors + Garmin sport, 15 + 31 conflicted files). Previous: [MERGE_DEV_2026-09-21_MTR.md](MERGE_DEV_2026-09-21_MTR.md) (`mtr/dev_OAPSAIMI` @ `468cf7a034` → `dev_OAPSAIMI_RB`; Dexcom ONE+ calibration sent to the sensor and AIMI telemetry retention, 7 conflicted files plus 22 files git added at pre-flip paths that are not source sets here). This is the second merge of the day. Previous: [MERGE_DEV_2026-09-21.md](MERGE_DEV_2026-09-21.md) (`dev` @ `73ce4b30d7` → `dev_OAPSAIMI_RB`; plugin start-failure handling and the `onStop` work scan, 16 conflicted files), [MERGE_DEV_2026-09-18_CWF.md](MERGE_DEV_2026-09-18_CWF.md) (`dev` @ `025c4163b7`; the finished Wear CWF / Watch Face Format work, 25 conflicted files), [MERGE_DEV_2026-09-18.md](MERGE_DEV_2026-09-18.md) (`dev` @ `aaa069fab385`; CareLevo pump, pump modules into folders, 10 conflicted files), [MERGE_DEV_2026-09-14.md](MERGE_DEV_2026-09-14.md) (`dev` @ `343f9f7673`; KMP layout + Hilt→Metro, 1115 conflicted files), [MERGE_DEV_2026-09-06.md](MERGE_DEV_2026-09-06.md) (`dev` @ `283a184f60`), [MERGE_DEV_2026-08-08.md](MERGE_DEV_2026-08-08.md) (`dev` @ `7fc8205e9a`), [MERGE_DEV_2026-08-03.md](MERGE_DEV_2026-08-03.md).
